...
Next, you need the FoxAPI jar, which can be downloaded from [BuiltByBit](https://builtbybit.com/resources/foxeconomy.89954/) or built from the [Github Repo](https://github.com/PlasmaServices/FoxAPI)
